...
#if (X_IS_TMC(2130) || X_IS_TMC(2660)) && !PIN_EXISTS(X_CS)
  #error "X_CS_PIN is required for X_DRIVER TYPE 2130 or 2660. Define X_CS_PIN in Configuration_adv.h."
#elif (X2_IS_TMC(2130) || X2_IS_TMC(2660)) && !PIN_EXISTS(X2_CS)
  #error "X2_CS_PIN is required for X2_DRIVER TYPE 2130 or 2660. Define X2_CS_PIN in Configuration_adv.h."
#elif (Y_IS_TMC(2130) || Y_IS_TMC(2660)) && !PIN_EXISTS(Y_CS)
  #error "Y_CS_PIN is required for Y_DRIVER TYPE 2130 or 2660. Define Y_CS_PIN in Configuration_adv.h."
#elif (Y2_IS_TMC(2130) || Y2_IS_TMC(2660)) && !PIN_EXISTS(Y2_CS)
  #error "Y2_CS_PIN is required for Y2_DRIVER TYPE 2130 or 2660. Define Y2_CS_PIN in Configuration_adv.h."
#elif (Z_IS_TMC(2130) || Z_IS_TMC(2660)) && !PIN_EXISTS(Z_CS)
  #error "Z_CS_PIN is required for Z_DRIVER TYPE 2130 or 2660. Define Z_CS_PIN in Configuration_adv.h."
#elif (Z2_IS_TMC(2130) || Z2_IS_TMC(2660)) && !PIN_EXISTS(Z2_CS)
  #error "Z2_CS_PIN is required for Z2_DRIVER TYPE 2130 or 2660. Define Z2_CS_PIN in Configuration_adv.h."
#elif (E0_IS_TMC(2130) || E0_IS_TMC(2660)) && !PIN_EXISTS(E0_CS)
  #error "E0_CS_PIN is required for E0_DRIVER TYPE 2130 or 2660. Define E0_CS_PIN in Configuration_adv.h."
#elif (E1_IS_TMC(2130) || E1_IS_TMC(2660)) && !PIN_EXISTS(E1_CS)
  #error "E1_CS_PIN is required for E1_DRIVER TYPE 2130 or 2660. Define E1_CS_PIN in Configuration_adv.h."
#elif (E2_IS_TMC(2130) || E2_IS_TMC(2660)) && !PIN_EXISTS(E2_CS)
  #error "E2_CS_PIN is required for E2_DRIVER TYPE 2130 or 2660. Define E2_CS_PIN in Configuration_adv.h."
#elif (E3_IS_TMC(2130) || E3_IS_TMC(2660)) && !PIN_EXISTS(E3_CS)
  #error "E3_CS_PIN is required for E3_DRIVER TYPE 2130 or 2660. Define E3_CS_PIN in Configuration_adv.h."
#elif (E4_IS_TMC(2130) || E4_IS_TMC(2660)) && !PIN_EXISTS(E4_CS)
  #error "E4_CS_PIN is required for E4_DRIVER TYPE 2130 or 2660. Define E4_CS_PIN in Configuration_adv.h."
#endif
 ...
 */
#if HAVE_TMC(2208) && ENABLED(ENDSTOP_INTERRUPTS_FEATURE) && !( \
