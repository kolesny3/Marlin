...
#define    HAS_STEALTHCHOP (HAVE_TMC(2130) || HAVE_TMC(2208) || HAVE_TMC(5130))
#define  X_HAS_STEALTHCHOP (X_IS_TMC(2130) || X_IS_TMC(2208) || X_IS_TMC(5130))
#define  Y_HAS_STEALTHCHOP (Y_IS_TMC(2130) || Y_IS_TMC(2208) || Y_IS_TMC(5130))
#define  Z_HAS_STEALTHCHOP (Z_IS_TMC(2130) || Z_IS_TMC(2208) || Z_IS_TMC(5130))
#define X2_HAS_STEALTHCHOP (X2_IS_TMC(2130) || X2_IS_TMC(2208))
#define Y2_HAS_STEALTHCHOP (Y2_IS_TMC(2130) || Y2_IS_TMC(2208))
#define Z2_HAS_STEALTHCHOP (Z2_IS_TMC(2130) || Z2_IS_TMC(2208))
#define E0_HAS_STEALTHCHOP (E0_IS_TMC(2130) || E0_IS_TMC(2208) || E0_IS_TMC(5130))
#define E1_HAS_STEALTHCHOP (E1_IS_TMC(2130) || E1_IS_TMC(2208))
#define E2_HAS_STEALTHCHOP (E2_IS_TMC(2130) || E2_IS_TMC(2208))
#define E3_HAS_STEALTHCHOP (E3_IS_TMC(2130) || E3_IS_TMC(2208))
#define E4_HAS_STEALTHCHOP (E4_IS_TMC(2130) || E4_IS_TMC(2208))

#define    HAS_STALLGUARD (HAVE_TMC(2130) || HAVE_TMC(2660) || HAVE_TMC(5130))
#define  X_HAS_STALLGUARD (X_IS_TMC(2130) || X_IS_TMC(2660) || X_IS_TMC(5130))
#define  Y_HAS_STALLGUARD (Y_IS_TMC(2130) || Y_IS_TMC(2660) || Y_IS_TMC(5130))
#define  Z_HAS_STALLGUARD (Z_IS_TMC(2130) || Z_IS_TMC(2660) || Z_IS_TMC(5130))
#define X2_HAS_STALLGUARD (X2_IS_TMC(2130) || X2_IS_TMC(2660))
#define Y2_HAS_STALLGUARD (Y2_IS_TMC(2130) || Y2_IS_TMC(2660))
#define Z2_HAS_STALLGUARD (Z2_IS_TMC(2130) || Z2_IS_TMC(2660))
#define E0_HAS_STALLGUARD (E0_IS_TMC(2130) || E0_IS_TMC(2660) || E0_IS_TMC(5130))
#define E1_HAS_STALLGUARD (E1_IS_TMC(2130) || E1_IS_TMC(2660))
#define E2_HAS_STALLGUARD (E2_IS_TMC(2130) || E2_IS_TMC(2660))
#define E3_HAS_STALLGUARD (E3_IS_TMC(2130) || E3_IS_TMC(2660))
#define E4_HAS_STALLGUARD (E4_IS_TMC(2130) || E4_IS_TMC(2660))
