...
void MarlinSettings::reset(PORTARG_SOLO) {
  ...
  void MarlinSettings::report(const bool forReplay
     ...
     */
      ...
      /**
       * TMC2130 / TMC2208 / TMC5130 stepper driver current
       */
      if (!forReplay) {
        CONFIG_ECHO_START;
      ...
      /**
       * TMC2130 / TMC2208 / TMC5130 Hybrid Threshold
       */
      #if ENABLED(HYBRID_THRESHOLD)
        if (!forReplay) {
          CONFIG_ECHO_START;
      ...
      /**
       * TMC2130 / TMC2660 Sensorless homing thresholds
       */
      #if ENABLED(SENSORLESS_HOMING)
        if (!forReplay) {
          CONFIG_ECHO_START;
        ...
        CONFIG_ECHO_START;
        #define HAS_X_SENSORLESS (defined(X_HOMING_SENSITIVITY) && X_HAS_STALLGUARD)
        #define HAS_Y_SENSORLESS (defined(Y_HOMING_SENSITIVITY) && Y_HAS_STALLGUARD)
        #define HAS_Z_SENSORLESS (defined(Z_HOMING_SENSITIVITY) && Z_HAS_STALLGUARD)
        ...
        #define HAS_X2_SENSORLESS (defined(X_HOMING_SENSITIVITY) && X2_HAS_STALLGUARD)
        #define HAS_Y2_SENSORLESS (defined(Y_HOMING_SENSITIVITY) && Y2_HAS_STALLGUARD)
        #define HAS_Z2_SENSORLESS (defined(Z_HOMING_SENSITIVITY) && Z2_HAS_STALLGUARD)
