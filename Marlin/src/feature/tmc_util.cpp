 ...
 */
  ...
  void monitor_tmc_driver(TMCMarlin<TMC> &st) {
    ...
    else if (st.otpw_cnt > 0) st.otpw_cnt = 0;
    ...
    if (report_tmc_status) {
      ...
      else if (st.otpw_cnt > 0) SERIAL_PRINT(st.otpw_cnt, DEC);
      else if (st.flag_otpw) SERIAL_CHAR('F');
      SERIAL_CHAR('\t');
    }
  }

  #define HAS_HW_COMMS(ST) ST##_IS_TMC(2130) || ST##_IS_TMC(2660) || (ST##_IS_TMC(2208) && defined(ST##_HARDWARE_SERIAL))
  ...
  template <typename TMC>
  static void tmc_status(TMCMarlin<TMC> &st, const TMC_debug_enum i, const float spmm) {
    SERIAL_ECHO('\t');
    switch (i) {
  ...
  void tmc_sensorless_homing(TMCMarlin<TMC2660Stepper> &st, const bool enable) {
    // TODO
  }
  ...
  void tmc_init_cs_pins() {
    #if X_IS_TMC(2130) || X_IS_TMC(2660)
      SET_CS_PIN(X);
    #endif
    #if Y_IS_TMC(2130) || Y_IS_TMC(2660)
      SET_CS_PIN(Y);
    #endif
    #if Z_IS_TMC(2130) || Z_IS_TMC(2660)
      SET_CS_PIN(Z);
    #endif
    #if X2_IS_TMC(2130) || X2_IS_TMC(2660)
      SET_CS_PIN(X2);
    #endif
    #if Y2_IS_TMC(2130) || Y2_IS_TMC(2660)
      SET_CS_PIN(Y2);
    #endif
    #if Z2_IS_TMC(2130) || Z2_IS_TMC(2660)
      SET_CS_PIN(Z2);
    #endif
    #if E0_IS_TMC(2130) || E0_IS_TMC(2660)
      SET_CS_PIN(E0);
    #endif
    #if E1_IS_TMC(2130) || E1_IS_TMC(2660)
      SET_CS_PIN(E1);
    #endif
    #if E2_IS_TMC(2130) || E2_IS_TMC(2660)
      SET_CS_PIN(E2);
    #endif
    #if E3_IS_TMC(2130) || E3_IS_TMC(2660)
      SET_CS_PIN(E3);
    #endif
    #if E4_IS_TMC(2130) || E4_IS_TMC(2660)
      SET_CS_PIN(E4);
    #endif
  }
